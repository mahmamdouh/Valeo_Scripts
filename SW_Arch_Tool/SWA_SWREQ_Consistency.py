...
def SWA_SWREQ_Consistency_Runnable(infoList):
    ...
    Task["Name"] = "Get polarion data for Req from both folders"
    Task["Progress"] = 0

    SWA_Array, SWAREQ_Array = Get_Data(infoList)

    Task["Name"] = "Filter Document By name"
    Task["Progress"] = 50
    ...
    Task["Name"] = "Compare whole Documents in over all view"
    Task["Progress"] = 60
    ...
    Task["Name"] = "find Miss-Consistency match Documents Names"
    Task["Progress"] = 65
    ...
    Task["Name"] = "Compare the missing IDs from document consistency with over all documents"
    Task["Progress"] = 80
    ...
    Task["Name"] = "Generate Inconsistency report"
    Task["Progress"] = 90
    ...
    while True:
        try:
            ...
            pass
    Task["Name"] = "Finished ! - consistency report Generated"
    Task["Progress"] = 100
