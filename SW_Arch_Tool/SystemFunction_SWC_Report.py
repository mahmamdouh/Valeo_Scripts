...
def SystemFunction_SWC_Report_Runnable(infoList):
    Task["Progress"] = 2
    # print("Step 1")
    ...
    Task["Progress"] = 85
    print("Step 666")
    docs_content_detail, SF_Array, workbook, worksheet3, work_item_listEmpty = SF_SWC_get_work_items_Details_data(
        docs_content, infoList, SF_Array, output_workbook)
    print("Step 7")
