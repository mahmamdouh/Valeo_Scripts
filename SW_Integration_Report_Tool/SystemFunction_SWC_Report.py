...
# main runnable to Get generate report of system function mapping to software components
# Input Dictionary of [polarion User , polarion password , project name , release folder location in polarion ]
